 ...
 */
namespace QuillSMTP\Vendor\Google\Http;

use QuillSMTP\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use QuillSMTP\Vendor\Google\Service\Exception as GoogleServiceException;
use QuillSMTP\Vendor\Google\Task\Runner;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (interface_exists('QuillSMTP\Vendor\GuzzleHttp\Message\ResponseInterface') && $response instanceof \QuillSMTP\Vendor\GuzzleHttp\Message\ResponseInterface) {
