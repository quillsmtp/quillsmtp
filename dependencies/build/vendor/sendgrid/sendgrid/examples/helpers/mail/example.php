...
use QuillSMTP\Vendor\SendGrid\Mail\Cc;
use QuillSMTP\Vendor\SendGrid\Mail\Bcc;
use QuillSMTP\Vendor\SendGrid\Mail\From;
use QuillSMTP\Vendor\SendGrid\Mail\Content;
...
use QuillSMTP\Vendor\SendGrid\Mail\Header;
use QuillSMTP\Vendor\SendGrid\Mail\CustomArg;
use QuillSMTP\Vendor\SendGrid\Mail\SendAt;
use QuillSMTP\Vendor\SendGrid\Mail\Attachment;
use QuillSMTP\Vendor\SendGrid\Mail\Asm;
use QuillSMTP\Vendor\SendGrid\Mail\MailSettings;
use QuillSMTP\Vendor\SendGrid\Mail\BccSettings;
use QuillSMTP\Vendor\SendGrid\Mail\SandBoxMode;
use QuillSMTP\Vendor\SendGrid\Mail\BypassBounceManagement;
use QuillSMTP\Vendor\SendGrid\Mail\BypassListManagement;
use QuillSMTP\Vendor\SendGrid\Mail\BypassSpamManagement;
use QuillSMTP\Vendor\SendGrid\Mail\BypassUnsubscribeManagement;
use QuillSMTP\Vendor\SendGrid\Mail\Footer;
use QuillSMTP\Vendor\SendGrid\Mail\SpamCheck;
use QuillSMTP\Vendor\SendGrid\Mail\TrackingSettings;
use QuillSMTP\Vendor\SendGrid\Mail\ClickTracking;
use QuillSMTP\Vendor\SendGrid\Mail\OpenTracking;
use QuillSMTP\Vendor\SendGrid\Mail\SubscriptionTracking;
use QuillSMTP\Vendor\SendGrid\Mail\Ganalytics;
use QuillSMTP\Vendor\SendGrid\Mail\ReplyTo;
function helloEmail()
{
    try {
...
function kitchenSink()
{
    try {
        ...
        $click_tracking->setEnable(\true);
        $click_tracking->setEnableText(\true);
        $tracking_settings->setClickTracking($click_tracking);
        $open_tracking = new OpenTracking();
        $open_tracking->setEnable(\true);
        ...
        $subscription_tracking->setEnable(\true);
...
function sendHelloEmail()
{
    ...
    $sg = new \QuillSMTP\Vendor\SendGrid($apiKey);
