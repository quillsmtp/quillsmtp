...
use QuillSMTP\Vendor\Aws\Sdk;
use QuillSMTP\Vendor\Aws\DynamoDb\DynamoDbClient;
use QuillSMTP\Vendor\Monolog\Formatter\FormatterInterface;
use QuillSMTP\Vendor\Aws\DynamoDb\Marshaler;
use QuillSMTP\Vendor\Monolog\Formatter\ScalarFormatter;
...
class DynamoDbHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(DynamoDbClient $client, string $table, $level = Logger::DEBUG, bool $bubble = \true)
    {
        ...
        if (defined('QuillSMTP\Vendor\Aws\Sdk::VERSION') && version_compare(Sdk::VERSION, '3.0', '>=')) {
            $this->version = 3;
