 ...
 */
namespace QuillSMTP\Vendor\phpseclib3\Crypt\EC\BaseCurves;

use QuillSMTP\Vendor\phpseclib3\Common\Functions\Strings;
use QuillSMTP\Vendor\phpseclib3\Math\BigInteger;
use QuillSMTP\Vendor\phpseclib3\Math\Common\FiniteField\Integer;
use QuillSMTP\Vendor\phpseclib3\Math\PrimeField;
use QuillSMTP\Vendor\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @author  Jim Wigginton <terrafrost@php.net>
