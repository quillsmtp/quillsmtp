	...
	private function define_mailers() {
		$this->mailers = array(
			'default'    => array(
				...
				'assets'      => array(
					'icon'   => QUILLSMTP_PLUGIN_URL . 'assets/mailer/default/icon.png',
					'banner' => QUILLSMTP_PLUGIN_URL . 'assets/mailer/default/banner.png',
				),
			),
			'sendlayer'  => array(
				...
				'assets'      => array(
					'icon'   => QUILLSMTP_PLUGIN_URL . 'assets/mailer/sendlayer/icon.png',
					'banner' => QUILLSMTP_PLUGIN_URL . 'assets/mailer/sendlayer/banner.png',
				),
			),
			'sendgrid'   => array(
			...
			'sendinblue' => array(
				...
				'assets'      => array(
					...
					'banner' => QUILLSMTP_PLUGIN_URL . 'assets/mailer/sendinblue/banner.png',
				),
			),
			'pepipost'   => array(
