...
use QuillSMTP\Vendor\SendGrid\Helper\Assert;
/**
...
class Mail implements \JsonSerializable
{
    ...
    private function addRecipientEmail($emailType, $email, $name = null, $substitutions = null, $personalizationIndex = null, $personalization = null)
    {
        ...
        if ($personalizationIndex === null && $personalization === null && $emailType === 'To' && $email->isPersonalized()) {
            $personalization = new Personalization();
        }
    ...
    private function addRecipientEmails($emailType, $emails, $personalizationIndex = null, $personalization = null)
    {
        ...
        if (\current($emails) instanceof EmailAddress) {
            foreach ($emails as $email) {
                $this->{$emailFunctionCall}($email, $name = null, $substitutions = null, $personalizationIndex, $personalization);
            }
        } else {
            foreach ($emails as $email => $name) {
                $this->{$emailFunctionCall}($email, $name, $substitutions = null, $personalizationIndex, $personalization);
            }
        }
    }
    /**
    ...
    public function getPersonalization($personalizationIndex = null, $personalization = null)
    {
        ...
        if ($personalizationIndex < 0 || $personalizationIndex > $personalizationCount) {
            throw new InvalidArgumentException('personalizationIndex ' . $personalizationIndex . ' must be less than ' . $personalizationCount);
        }
     ...
     * @throws TypeException
     */
    public function addCc($cc, $name = null, $substitutions = null, $personalizationIndex = null, $personalization = null)
    {
        $this->addRecipientEmail('Cc', $cc, $name, $substitutions, $personalizationIndex, $personalization);
    }
    /**
     ...
     * @throws TypeException
     */
    public function addBcc($bcc, $name = null, $substitutions = null, $personalizationIndex = null, $personalization = null)
    {
        $this->addRecipientEmail('Bcc', $bcc, $name, $substitutions, $personalizationIndex, $personalization);
    }
    /**
    ...
    public function enableBypassBounceManagement()
    {
        ...
        $this->mail_settings->setBypassBounceManagement(\true);
    }
    /**
    ...
    public function enableBypassListManagement()
    {
        ...
        $this->mail_settings->setBypassListManagement(\true);
    }
    /**
    ...
    public function enableBypassSpamManagement()
    {
        ...
        $this->mail_settings->setBypassSpamManagement(\true);
    }
    /**
    ...
    public function enableBypassUnsubscribeManagement()
    {
        ...
        $this->mail_settings->setBypassUnsubscribeManagement(\true);
    }
    /**
    ...
    public function enableSandBoxMode()
    {
        ...
        $this->mail_settings->setSandBoxMode(\true);
    }
    /**
