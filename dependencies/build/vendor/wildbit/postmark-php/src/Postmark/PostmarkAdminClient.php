...
class PostmarkAdminClient extends PostmarkClientBase
{
     ...
     * @return DynamicResponseModel
     */
    function createServer($name, $color = NULL, $rawEmailEnabled = NULL, $smtpApiActivated = NULL, $inboundHookUrl = NULL, $bounceHookUrl = NULL, $openHookUrl = NULL, $postFirstOpenOnly = NULL, $trackOpens = NULL, $inboundDomain = NULL, $inboundSpamThreshold = NULL, $trackLinks = NULL, $clickHookUrl = NULL, $deliveryHookUrl = NULL, $enableSmtpApiErrorHooks = NULL)
    {
        $body = array();
        $body['name'] = $name;
        $body['color'] = $color;
