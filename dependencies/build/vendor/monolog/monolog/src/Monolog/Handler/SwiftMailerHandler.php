...
use QuillSMTP\Vendor\Swift_Message;
use QuillSMTP\Vendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\QuillSMTP\Vendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
