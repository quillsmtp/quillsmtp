...
use QuillSMTP\Vendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use QuillSMTP\Vendor\Monolog\Logger;
use QuillSMTP\Vendor\Monolog\Formatter\FormatterInterface;
use QuillSMTP\Vendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use QuillSMTP\Vendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use QuillSMTP\Vendor\Elasticsearch\Client;
use QuillSMTP\Vendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use QuillSMTP\Vendor\Elastic\Elasticsearch\Client as Client8;
/**
