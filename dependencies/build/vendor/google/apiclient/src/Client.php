 ...
 */
namespace QuillSMTP\Vendor\Google;

use BadMethodCallException;
use DomainException;
use QuillSMTP\Vendor\Google\AccessToken\Revoke;
use QuillSMTP\Vendor\Google\AccessToken\Verify;
use QuillSMTP\Vendor\Google\Auth\ApplicationDefaultCredentials;
use QuillSMTP\Vendor\Google\Auth\Cache\MemoryCacheItemPool;
use QuillSMTP\Vendor\Google\Auth\Credentials\ServiceAccountCredentials;
use QuillSMTP\Vendor\Google\Auth\Credentials\UserRefreshCredentials;
use QuillSMTP\Vendor\Google\Auth\CredentialsLoader;
use QuillSMTP\Vendor\Google\Auth\FetchAuthTokenCache;
use QuillSMTP\Vendor\Google\Auth\GetUniverseDomainInterface;
use QuillSMTP\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use QuillSMTP\Vendor\Google\Auth\OAuth2;
use QuillSMTP\Vendor\Google\AuthHandler\AuthHandlerFactory;
use QuillSMTP\Vendor\Google\Http\REST;
use QuillSMTP\Vendor\GuzzleHttp\Client as GuzzleClient;
use QuillSMTP\Vendor\GuzzleHttp\ClientInterface;
use QuillSMTP\Vendor\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use QuillSMTP\Vendor\Monolog\Handler\StreamHandler as MonologStreamHandler;
use QuillSMTP\Vendor\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
