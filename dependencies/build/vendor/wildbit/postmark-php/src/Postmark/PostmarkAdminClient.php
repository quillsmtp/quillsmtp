...
use QuillSMTP\Vendor\Postmark\Models\DataRemovalRequestResponse;
use QuillSMTP\Vendor\Postmark\Models\PostmarkDomain;
use QuillSMTP\Vendor\Postmark\Models\PostmarkDomainDetails;
use QuillSMTP\Vendor\Postmark\Models\PostmarkDomainList;
use QuillSMTP\Vendor\Postmark\Models\PostmarkException;
use QuillSMTP\Vendor\Postmark\Models\PostmarkResponse;
use QuillSMTP\Vendor\Postmark\Models\PostmarkSenderSignature;
use QuillSMTP\Vendor\Postmark\Models\PostmarkSenderSignatureList;
use QuillSMTP\Vendor\Postmark\Models\PostmarkServer;
use QuillSMTP\Vendor\Postmark\Models\PostmarkServerList;
/**
...
class PostmarkAdminClient extends PostmarkClientBase
{
     ...
     * @throws PostmarkException
     */
    public function editServer(int $id, string $name = null, string $color = null, bool $rawEmailEnabled = null, bool $smtpApiActivated = null, string $inboundHookUrl = null, string $bounceHookUrl = null, string $openHookUrl = null, bool $postFirstOpenOnly = null, bool $trackOpens = null, string $inboundDomain = null, int $inboundSpamThreshold = null, string $trackLinks = null, string $clickHookUrl = null, string $deliveryHookUrl = null, string $enableSmtpApiErrorHooks = null) : PostmarkServer
    {
        $body = [];
        $body['name'] = $name;
        $body['color'] = $color;
     ...
     * @throws PostmarkException
     */
    public function createServer(string $name, string $color = null, bool $rawEmailEnabled = null, bool $smtpApiActivated = null, string $inboundHookUrl = null, string $bounceHookUrl = null, string $openHookUrl = null, bool $postFirstOpenOnly = null, bool $trackOpens = null, string $inboundDomain = null, int $inboundSpamThreshold = null, string $trackLinks = null, string $clickHookUrl = null, string $deliveryHookUrl = null, string $enableSmtpApiErrorHooks = null) : PostmarkServer
    {
        $body = [];
        $body['name'] = $name;
        $body['color'] = $color;
     ...
     * @throws PostmarkException
     */
    public function createDataRemovalRequest(string $requestedBy, string $requestedFor, bool $notifyWhenCompleted) : DataRemovalRequestResponse
    {
        $body = [];
