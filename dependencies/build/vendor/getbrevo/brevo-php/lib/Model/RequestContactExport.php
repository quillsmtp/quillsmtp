...
class RequestContactExport implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['exportAttributes' => 'string[]', 'customContactFilter' => 'QuillSMTP\\Brevo\\Client\\Model\\RequestContactExportCustomContactFilter', 'notifyUrl' => 'string'];
    /**
