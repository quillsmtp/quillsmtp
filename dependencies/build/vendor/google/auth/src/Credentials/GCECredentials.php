...
use QuillSMTP\Vendor\Google\Auth\Iam;
use QuillSMTP\Vendor\Google\Auth\IamSignerTrait;
use QuillSMTP\Vendor\Google\Auth\ProjectIdProviderInterface;
use QuillSMTP\Vendor\Google\Auth\SignBlobInterface;
use QuillSMTP\Vendor\GuzzleHttp\Exception\ClientException;
use QuillSMTP\Vendor\GuzzleHttp\Exception\ConnectException;
use QuillSMTP\Vendor\GuzzleHttp\Exception\RequestException;
use QuillSMTP\Vendor\GuzzleHttp\Exception\ServerException;
