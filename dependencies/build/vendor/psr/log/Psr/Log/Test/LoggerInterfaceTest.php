...
namespace QuillSMTP\Vendor\Psr\Log\Test;

use QuillSMTP\Vendor\Psr\Log\LoggerInterface;
use QuillSMTP\Vendor\Psr\Log\LogLevel;
use QuillSMTP\Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('QuillSMTP\\Vendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('QuillSMTP\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('QuillSMTP\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
