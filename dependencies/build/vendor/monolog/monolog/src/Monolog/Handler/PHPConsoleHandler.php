...
use QuillSMTP\Vendor\PhpConsole\Connector;
use QuillSMTP\Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use QuillSMTP\Vendor\PhpConsole\Helper;
use QuillSMTP\Vendor\Monolog\LogRecord;
use QuillSMTP\Vendor\PhpConsole\Storage;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('QuillSMTP\\Vendor\\PhpConsole\\Connector')) {
