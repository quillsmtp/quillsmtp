...
namespace QuillSMTP\Vendor\Postmark;

use QuillSMTP\Vendor\Postmark\Models\DynamicResponseModel;
use QuillSMTP\Vendor\Postmark\Models\MessageStream\PostmarkMessageStream;
use QuillSMTP\Vendor\Postmark\Models\MessageStream\PostmarkMessageStreamArchivalConfirmation;
use QuillSMTP\Vendor\Postmark\Models\MessageStream\PostmarkMessageStreamList;
use QuillSMTP\Vendor\Postmark\Models\PostmarkBounce;
use QuillSMTP\Vendor\Postmark\Models\PostmarkBounceActivation;
use QuillSMTP\Vendor\Postmark\Models\PostmarkBounceDump;
use QuillSMTP\Vendor\Postmark\Models\PostmarkBounceList;
use QuillSMTP\Vendor\Postmark\Models\PostmarkClickList;
use QuillSMTP\Vendor\Postmark\Models\PostmarkDeliveryStats;
use QuillSMTP\Vendor\Postmark\Models\PostmarkException;
use QuillSMTP\Vendor\Postmark\Models\PostmarkInboundMessage;
use QuillSMTP\Vendor\Postmark\Models\PostmarkInboundMessageList;
use QuillSMTP\Vendor\Postmark\Models\PostmarkInboundRuleTrigger;
use QuillSMTP\Vendor\Postmark\Models\PostmarkInboundRuleTriggerList;
use QuillSMTP\Vendor\Postmark\Models\PostmarkMessage;
use QuillSMTP\Vendor\Postmark\Models\PostmarkMessageDump;
use QuillSMTP\Vendor\Postmark\Models\PostmarkOpenList;
use QuillSMTP\Vendor\Postmark\Models\PostmarkOutboundMessageDetail;
use QuillSMTP\Vendor\Postmark\Models\PostmarkOutboundMessageList;
use QuillSMTP\Vendor\Postmark\Models\PostmarkResponse;
use QuillSMTP\Vendor\Postmark\Models\PostmarkServer;
use QuillSMTP\Vendor\Postmark\Models\PostmarkTemplate;
use QuillSMTP\Vendor\Postmark\Models\PostmarkTemplateList;
use QuillSMTP\Vendor\Postmark\Models\Stats\PostmarkOutboundBounceStats;
use QuillSMTP\Vendor\Postmark\Models\Stats\PostmarkOutboundClickStats;
// use Postmark\Models\Stats\PostmarkOutboundReadStats;
use QuillSMTP\Vendor\Postmark\Models\Stats\PostmarkOutboundOpenStats;
use QuillSMTP\Vendor\Postmark\Models\Stats\PostmarkOutboundOverviewStats;
use QuillSMTP\Vendor\Postmark\Models\Stats\PostmarkOutboundPlatformStats;
use QuillSMTP\Vendor\Postmark\Models\Stats\PostmarkOutboundSentStats;
use QuillSMTP\Vendor\Postmark\Models\Stats\PostmarkOutboundSpamComplaintStats;
use QuillSMTP\Vendor\Postmark\Models\Stats\PostmarkOutboundTrackedStats;
use QuillSMTP\Vendor\Postmark\Models\Suppressions\PostmarkSuppressionList;
use QuillSMTP\Vendor\Postmark\Models\Suppressions\PostmarkSuppressionResultList;
use QuillSMTP\Vendor\Postmark\Models\TemplatedPostmarkMessage;
use QuillSMTP\Vendor\Postmark\Models\TemplateValidationResponse;
use QuillSMTP\Vendor\Postmark\Models\Webhooks\WebhookConfiguration;
use QuillSMTP\Vendor\Postmark\Models\Webhooks\WebhookConfigurationListingResponse;
/**
...
class PostmarkClient extends PostmarkClientBase
{
     ...
     */
    public function __construct(string $serverToken, int $timeout = 60)
    {
     ...
     */
    public function sendEmail(string $from, string $to, string $subject, ?string $htmlBody = null, ?string $textBody = null, ?string $tag = null, ?bool $trackOpens = null, ?string $replyTo = null, ?string $cc = null, ?string $bcc = null, ?array $headers = null, ?array $attachments = null, ?string $trackLinks = null, ?array $metadata = null, ?string $messageStream = null) : PostmarkResponse
    {
        $body = [];
        $body['From'] = $from;
        $body['To'] = $to;
    ...
    public function sendEmailBatchWithTemplate(array $emailBatch = []) : array
    {
        ...
        $response = (array) $this->processRestRequest('POST', '/email/batchWithTemplates', ['Messages' => $final]);
        $temp = [];
        foreach ($response as $rep) {
            $obj = \json_decode(\json_encode($rep));
            $postmarkResponse = new PostmarkResponse((array) $obj);
     ...
     * @throws PostmarkException
     */
    public function sendEmailWithTemplate(string $from, string $to, int|string $templateIdOrAlias, array $templateModel, bool $inlineCss = \true, ?string $tag = null, ?bool $trackOpens = null, ?string $replyTo = null, ?string $cc = null, ?string $bcc = null, ?array $headers = null, ?array $attachments = null, ?string $trackLinks = null, ?array $metadata = null, ?string $messageStream = null) : PostmarkResponse
    {
        $body = [];
        $body['From'] = $from;
        $body['To'] = $to;
     ...
     * @throws PostmarkException
     */
    public function getBounces(int $count = 100, int $offset = 0, ?string $type = null, ?bool $inactive = null, ?string $emailFilter = null, ?string $tag = null, ?int $messageID = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkBounceList
    {
        $query = [];
        $query['type'] = $type;
     ...
     * @throws PostmarkException
     */
    public function getOutboundMessages(int $count = 100, int $offset = 0, ?string $recipient = null, ?string $fromEmail = null, ?string $tag = null, ?string $subject = null, ?string $status = null, ?string $fromdate = null, ?string $todate = null, ?array $metadata = null, ?string $messagestream = null) : PostmarkOutboundMessageList
    {
        $query = [];
    ...
    {
        return new PostmarkOutboundMessageDetail((array) $this->processRestRequest('GET', "/messages/outbound/{$id}/details"));
    }
    /**
     ...
     * @throws PostmarkException
     */
    public function getInboundMessages(int $count = 100, int $offset = 0, ?string $recipient = null, ?string $fromEmail = null, ?string $tag = null, ?string $subject = null, ?string $mailboxHash = null, ?string $status = null, ?string $fromdate = null, ?string $todate = null) : PostmarkInboundMessageList
    {
        $query = [];
        $query['recipient'] = $recipient;
        $query['fromemail'] = $fromEmail;
    ...
    {
        return new PostmarkResponse((array) $this->processRestRequest('PUT', "/messages/inbound/{$id}/bypass"));
    }
    /**
    ...
    {
        return new PostmarkResponse((array) $this->processRestRequest('PUT', "/messages/inbound/{$id}/retry"));
    }
    /**
     ...
     * @throws PostmarkException
     */
    public function getOpenStatistics(int $count = 100, int $offset = 0, ?string $recipient = null, ?string $tag = null, ?string $clientName = null, ?string $clientCompany = null, ?string $clientFamily = null, ?string $osName = null, ?string $osFamily = null, ?string $osCompany = null, ?string $platform = null, ?string $country = null, ?string $region = null, ?string $city = null, ?string $messagestream = null) : PostmarkOpenList
    {
        $query = [];
        $query['count'] = $count;
        $query['offset'] = $offset;
     ...
     * @throws PostmarkException
     */
    public function getClickStatistics(int $count = 100, int $offset = 0, ?string $recipient = null, ?string $tag = null, ?string $clientName = null, ?string $clientCompany = null, ?string $clientFamily = null, ?string $osName = null, ?string $osFamily = null, ?string $osCompany = null, ?string $platform = null, ?string $country = null, ?string $region = null, ?string $city = null, ?string $messagestream = null) : PostmarkClickList
    {
        $query = [];
        $query['count'] = $count;
        $query['offset'] = $offset;
     ...
     * @throws PostmarkException
     */
    public function getClickStatisticsForMessage(string $id, int $count = 100, int $offset = 0) : PostmarkClickList
    {
        $query = [];
        $query['count'] = $count;
        $query['offset'] = $offset;
        return new PostmarkClickList((array) $this->processRestRequest('GET', "/messages/outbound/clicks/{$id}", $query));
    }
    /**
     ...
     * @throws PostmarkException
     */
    public function getOutboundOverviewStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundOverviewStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
        $query['todate'] = $todate;
        $query['messagestream'] = $messagestream;
        return new PostmarkOutboundOverviewStats((array) $this->processRestRequest('GET', '/stats/outbound', $query));
    }
    /**
     ...
     * @throws PostmarkException
     */
    public function getOutboundSendStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundSentStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
        $query['todate'] = $todate;
        $query['messagestream'] = $messagestream;
        return new PostmarkOutboundSentStats((array) $this->processRestRequest('GET', '/stats/outbound/sends', $query));
    }
    /**
     ...
     * @throws PostmarkException
     */
    public function getOutboundBounceStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundBounceStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @throws PostmarkException
     */
    public function getOutboundSpamComplaintStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundSpamComplaintStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @throws PostmarkException
     */
    public function getOutboundTrackedStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundTrackedStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @throws PostmarkException
     */
    public function getOutboundOpenStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundOpenStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @throws PostmarkException
     */
    public function getOutboundPlatformStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundPlatformStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @throws PostmarkException
     */
    public function getOutboundEmailClientStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : DynamicResponseModel
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @throws PostmarkException
     */
    public function getOutboundClickStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundClickStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @throws PostmarkException
     */
    public function getOutboundClickBrowserFamilyStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundClickStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @throws PostmarkException
     */
    public function getOutboundClickBrowserPlatformStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : PostmarkOutboundPlatformStats
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @throws PostmarkException
     */
    public function getOutboundClickLocationStatistics(?string $tag = null, ?string $fromdate = null, ?string $todate = null, ?string $messagestream = null) : DynamicResponseModel
    {
        $query = [];
        $query['tag'] = $tag;
        $query['fromdate'] = $fromdate;
     ...
     * @param null|string $htmlBody       the template to be used for the 'htmlBody' of emails sent using this template, optional if 'textBody' is not NULL
     * @param null|string $textBody       the template to be used for the 'textBody' of emails sent using this template, optional if 'htmlBody' is not NULL
     ...
     * @throws PostmarkException
     */
    public function createTemplate(string $name, ?string $subject, ?string $htmlBody, ?string $textBody, ?string $alias = null, string $templateType = 'Standard', ?string $layoutTemplate = null) : PostmarkTemplate
    {
        $template = [];
        $template['name'] = $name;
     ...
     * @throws PostmarkException
     */
    public function editTemplate(string $id, ?string $name = null, ?string $subject = null, ?string $htmlBody = null, ?string $textBody = null, ?string $alias = null, ?string $layoutTemplate = null) : PostmarkTemplate
    {
        $template = [];
        $template['name'] = $name;
        $template['subject'] = $subject;
     ...
     * @throws PostmarkException
     */
    public function listTemplates(int $count = 100, int $offset = 0, string $templateType = 'All', ?string $layoutTemplate = null) : PostmarkTemplateList
    {
        $query = [];
        $query['count'] = $count;
        $query['offset'] = $offset;
     ...
     * @throws PostmarkException
     */
    public function validateTemplate(?string $subject = null, ?string $htmlBody = null, ?string $textBody = null, ?object $testRenderModel = null, ?bool $inlineCssForHtmlTestRender = \true, string $templateType = 'Standard', ?string $layoutTemplate = null) : TemplateValidationResponse
    {
        $query = [];
        $query['subject'] = $subject;
     ...
     * @throws PostmarkException
     */
    public function createWebhookConfiguration(string $url, ?string $messageStream = null, ?object $httpAuth = null, ?array $httpHeaders = null, ?object $triggers = null) : WebhookConfiguration
    {
        $body = [];
        $body['Url'] = $url;
        $body['MessageStream'] = $messageStream;
     ...
     * @throws PostmarkException
     */
    public function editWebhookConfiguration(int $id, ?string $url = null, ?object $httpAuth = null, ?array $httpHeaders = null, ?object $triggers = null) : WebhookConfiguration
    {
        $body = [];
        $body['Url'] = $url;
        $body['HttpAuth'] = $httpAuth;
     ...
     * @throws PostmarkException
     */
    public function getSuppressions(?string $messageStream = null, ?string $suppressionReason = null, ?string $origin = null, ?string $fromDate = null, ?string $toDate = null, ?string $emailAddress = null) : PostmarkSuppressionList
    {
        $query = [];
