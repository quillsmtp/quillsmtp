...
use QuillSMTP\Vendor\Postmark\Models\DynamicResponseModel as DynamicResponseModel;
use QuillSMTP\Vendor\Postmark\PostmarkClientBase as PostmarkClientBase;
/**
...
class PostmarkClient extends PostmarkClientBase
{
     ...
     */
    function sendEmail($from, $to, $subject, $htmlBody = NULL, $textBody = NULL, $tag = NULL, $trackOpens = NULL, $replyTo = NULL, $cc = NULL, $bcc = NULL, $headers = NULL, $attachments = NULL, $trackLinks = NULL, $metadata = NULL, $messageStream = NULL)
    {
        $body = array();
        $body['From'] = $from;
        $body['To'] = $to;
     ...
     * @return DynamicResponseModel
     */
    function sendEmailWithTemplate($from, $to, $templateIdOrAlias, $templateModel, $inlineCss = \true, $tag = NULL, $trackOpens = NULL, $replyTo = NULL, $cc = NULL, $bcc = NULL, $headers = NULL, $attachments = NULL, $trackLinks = NULL, $metadata = NULL, $messageStream = NULL)
    {
        $body = array();
        $body['From'] = $from;
        $body['To'] = $to;
     ...
     * @return DynamicResponseModel
     */
    function getBounces($count = 100, $offset = 0, $type = NULL, $inactive = NULL, $emailFilter = NULL, $tag = NULL, $messageID = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL)
    {
        $query = array();
        $query['type'] = $type;
     ...
     * @return DynamicResponseModel
     */
    function editServer($name = NULL, $color = NULL, $rawEmailEnabled = NULL, $smtpApiActivated = NULL, $inboundHookUrl = NULL, $bounceHookUrl = NULL, $openHookUrl = NULL, $postFirstOpenOnly = NULL, $trackOpens = NULL, $inboundDomain = NULL, $inboundSpamThreshold = NULL, $trackLinks = NULL, $clickHookUrl = NULL, $deliveryHookUrl = NULL)
    {
        $body = array();
        $body["Name"] = $name;
        $body["Color"] = $color;
     ...
     * @return DynamicResponseModel
     */
    function getOutboundMessages($count = 100, $offset = 0, $recipient = NULL, $fromEmail = NULL, $tag = NULL, $subject = NULL, $status = NULL, $fromdate = NULL, $todate = NULL, $metadata = NULL, $messagestream = NULL)
    {
        $query = array();
     ...
     * @return DynamicResponseModel
     */
    function getOpenStatistics($count = 100, $offset = 0, $recipient = NULL, $tag = NULL, $clientName = NULL, $clientCompany = NULL, $clientFamily = NULL, $osName = NULL, $osFamily = NULL, $osCompany = NULL, $platform = NULL, $country = NULL, $region = NULL, $city = NULL, $messagestream = NULL)
    {
        $query = array();
        $query['count'] = $count;
        $query['offset'] = $offset;
     ...
     * @return DynamicResponseModel
     */
    function getClickStatistics($count = 100, $offset = 0, $recipient = NULL, $tag = NULL, $clientName = NULL, $clientCompany = NULL, $clientFamily = NULL, $osName = NULL, $osFamily = NULL, $osCompany = NULL, $platform = NULL, $country = NULL, $region = NULL, $city = NULL, $messagestream = NULL)
    {
        $query = array();
        $query['count'] = $count;
        $query['offset'] = $offset;
     ...
     * @return DynamicResponseModel
     */
    function validateTemplate($subject = NULL, $htmlBody = NULL, $textBody = NULL, $testRenderModel = NULL, $inlineCssForHtmlTestRender = \true, $templateType = 'Standard', $layoutTemplate = NULL)
    {
        $query = array();
        $query["subject"] = $subject;
