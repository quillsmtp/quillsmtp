...
use QuillSMTP\Vendor\SendGrid\Client;
use QuillSMTP\Vendor\SendGrid\Mail\Mail;
use QuillSMTP\Vendor\SendGrid\Response;
/**
...
abstract class BaseSendGridClientInterface
{
    ...
    public $allowedRegionsHostMap = ["eu" => "https://api.eu.sendgrid.com", "global" => "https://api.sendgrid.com"];
    /**
    ...
    public function __construct($auth, $host, $options = array())
    {
        ...
        $this->client->setVerifySSLCerts(isset($options['verify_ssl']) ? $options['verify_ssl'] : \true);
    }
    /**
     * Make an API request.
     *
