 ...
 */
namespace QuillSMTP\Vendor\phpseclib3\Net;

use QuillSMTP\Vendor\phpseclib3\Common\Functions\Strings;
use QuillSMTP\Vendor\phpseclib3\Crypt\Blowfish;
use QuillSMTP\Vendor\phpseclib3\Crypt\ChaCha20;
use QuillSMTP\Vendor\phpseclib3\Crypt\Common\AsymmetricKey;
use QuillSMTP\Vendor\phpseclib3\Crypt\Common\PrivateKey;
use QuillSMTP\Vendor\phpseclib3\Crypt\Common\PublicKey;
use QuillSMTP\Vendor\phpseclib3\Crypt\Common\SymmetricKey;
use QuillSMTP\Vendor\phpseclib3\Crypt\DH;
use QuillSMTP\Vendor\phpseclib3\Crypt\DSA;
use QuillSMTP\Vendor\phpseclib3\Crypt\EC;
use QuillSMTP\Vendor\phpseclib3\Crypt\Hash;
use QuillSMTP\Vendor\phpseclib3\Crypt\Random;
use QuillSMTP\Vendor\phpseclib3\Crypt\RC4;
use QuillSMTP\Vendor\phpseclib3\Crypt\Rijndael;
use QuillSMTP\Vendor\phpseclib3\Crypt\RSA;
use QuillSMTP\Vendor\phpseclib3\Crypt\TripleDES;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use QuillSMTP\Vendor\phpseclib3\Crypt\Twofish;
use QuillSMTP\Vendor\phpseclib3\Exception\ConnectionClosedException;
use QuillSMTP\Vendor\phpseclib3\Exception\InsufficientSetupException;
use QuillSMTP\Vendor\phpseclib3\Exception\InvalidPacketLengthException;
use QuillSMTP\Vendor\phpseclib3\Exception\NoSupportedAlgorithmsException;
use QuillSMTP\Vendor\phpseclib3\Exception\UnableToConnectException;
use QuillSMTP\Vendor\phpseclib3\Exception\UnsupportedAlgorithmException;
use QuillSMTP\Vendor\phpseclib3\Exception\UnsupportedCurveException;
use QuillSMTP\Vendor\phpseclib3\Math\BigInteger;
use QuillSMTP\Vendor\phpseclib3\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class SSH2
{
    ...
    private function connect()
    {
        ...
        $extra = $matches[1];
        if (\defined('QuillSMTP\\Vendor\\NET_SSH2_LOGGING')) {
    ...
    {
        if (\defined('QuillSMTP\\Vendor\\NET_SSH2_LOGGING') && NET_SSH2_LOGGING == self::LOG_COMPLEX) {
