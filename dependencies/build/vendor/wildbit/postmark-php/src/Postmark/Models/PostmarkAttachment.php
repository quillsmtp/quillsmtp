...
class PostmarkAttachment implements \JsonSerializable
{
    ...
    {
        $retval = array("Name" => $this->name, "Content" => $this->data, "ContentType" => $this->mimeType ? $this->mimeType : "application/octet-stream", "ContentId" => $this->contentId ? $this->contentId : $this->name);
        return $retval;
    }
