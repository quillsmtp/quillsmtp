 ...
 */
namespace QuillSMTP\Vendor\phpseclib3\Crypt\Common;
...
use QuillSMTP\Vendor\phpseclib3\Exception\BadDecryptionException;
use QuillSMTP\Vendor\phpseclib3\Exception\BadModeException;
use QuillSMTP\Vendor\phpseclib3\Exception\InconsistentSetupException;
...
use QuillSMTP\Vendor\phpseclib3\Math\BinaryField;
use QuillSMTP\Vendor\phpseclib3\Math\PrimeField;
/**
 * Base Class for all \phpseclib3\Crypt\* cipher classes
 *
 * @author  Jim Wigginton <terrafrost@php.net>
