...
class WebhookConfigurationTriggers implements JsonSerializable
{
     ...
     */
    public function __construct(WebhookConfigurationOpenTrigger $open = null, WebhookConfigurationClickTrigger $click = null, WebhookConfigurationDeliveryTrigger $delivery = null, WebhookConfigurationBounceTrigger $bounce = null, WebhookConfigurationSpamComplaintTrigger $spamComplaint = null, WebhookConfigurationSubscriptionChangeTrigger $subscriptionChange = null)
    {
        $this->Open = $open;
        $this->Click = $click;
