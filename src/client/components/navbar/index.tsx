	...
	return (
		<>
			<div className="qsmtp-header">
				...
				<NavLink className="qsmtp-header-link" to="/" exact isActive={(match, location) => {
					if (
						location.pathname ===
						"" ||
						location.pathname ===
				...
				<NavLink className="qsmtp-header-link" to="/" exact isActive={(match, location) => {
					...
					{__('Mailers', 'quillsmtp')}
				</NavLink>

				<a className="qsmtp-header-link active" href="#"><svg viewBox="-6 0 512 512" fill="currentColor">
				...
				<a className="qsmtp-header-link" href="#"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
				...
				<a className="qsmtp-header-link" href="#"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
