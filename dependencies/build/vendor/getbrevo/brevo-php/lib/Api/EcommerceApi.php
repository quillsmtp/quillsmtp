...
class EcommerceApi
{
    ...
    {
        return $this->getProductsAsyncWithHttpInfo($limit, $offset, $sort, $ids, $name, $priceLte, $priceGte, $priceLt, $priceGt, $priceEq, $priceNe, $categories)->then(function ($response) {
            return $response[0];
        });
    }
    /**
