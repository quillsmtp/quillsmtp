...
class SignAndEncryptKeyPairs extends \QuillSMTP\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SignAndEncryptKeyPairs::class, 'QuillSMTP\\Vendor\\Google_Service_Gmail_SignAndEncryptKeyPairs');
