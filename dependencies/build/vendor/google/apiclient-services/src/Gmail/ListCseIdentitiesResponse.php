...
class ListCseIdentitiesResponse extends \QuillSMTP\Vendor\Google\Collection
{
...
class_alias(ListCseIdentitiesResponse::class, 'QuillSMTP\Vendor\Google_Service_Gmail_ListCseIdentitiesResponse');
