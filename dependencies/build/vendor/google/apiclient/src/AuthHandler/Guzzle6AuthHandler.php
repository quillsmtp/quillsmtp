...
namespace QuillSMTP\Vendor\Google\AuthHandler;
...
use QuillSMTP\Vendor\Google\Auth\Middleware\ScopedAccessTokenMiddleware;
use QuillSMTP\Vendor\Google\Auth\Middleware\SimpleMiddleware;
