...
{
    $form = (string) new \QuillSMTP\Vendor\SendGrid\Contacts\RecipientForm($url);
    echo $form . \PHP_EOL;
}
...
function recipientFormSubmit()
{
    ...
    $recipient = new \QuillSMTP\Vendor\SendGrid\Contacts\Recipient($firstName, $lastName, $email);
