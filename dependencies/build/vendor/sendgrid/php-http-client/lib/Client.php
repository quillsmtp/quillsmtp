...
use QuillSMTP\Vendor\SendGrid\Exception\InvalidRequest;
/**
 * Class Client
 * @version 3.9.5
 *
...
class Client
{
     ...
     */
    public function __construct($host, $headers = null, $version = null, $path = null, $curlOptions = null, $retryOnLimit = \false, $verifySSLCerts = \true)
    {
        $this->host = $host;
    ...
    public function __call($name, $args)
    {
        ...
        if (\in_array($name, $this->methods, \true)) {
